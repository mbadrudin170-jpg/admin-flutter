...
class _PelangganAktifPageState extends State<PelangganAktifPage> {
  ...
  void _periksaDanJadwalkanNotifikasi(List<PelangganAktif> pelanggan) async {
    final NotifikasiServis notifikasiServis = NotifikasiServis();
        ...
        if (paket == null) {
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text(
                  'Paket tidak ditemukan, tidak bisa mengarsipkan.',
                ),
    ...
    return [
      IconButton(
        icon: Icon(
          ...
          color: _tampilkanBelumSinkron ? Colors.orange : null,
        ),
        onPressed: () {
          setState(() {
            _tampilkanBelumSinkron = !_tampilkanBelumSinkron;
          });
          _applyFilterAndSort();
        },
        tooltip: _tampilkanBelumSinkron
            ? 'Tampilkan Semua'
            : 'Hanya Tampilkan Belum Sinkron',
      ),
      IconButton(
