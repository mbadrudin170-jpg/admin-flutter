...
void main() {
  ...
  group('FormatTanggal', () {
    ...
    test('formatTanggalDanJam harus memformat tanggal dan waktu dengan benar', () {
      // Output yang diharapkan: "17 Agu 2024, 10:30"
      expect(FormatTanggal.formatTanggalDanJam(testDate), '17 Agu 2024, 10:30');
    });
  ...
  group('FormatJam', () {
    ...
    test('formatJamLengkap harus memformat waktu dengan detik dengan benar (HH:mm:ss)', () {
    ...
    test('formatTeksKeJam harus mengembalikan fallback untuk string yang tidak valid', () {
      const invalidString = 'ini-bukan-tanggal';
      expect(FormatJam.formatTeksKeJam(invalidString), '--:--');
    });

    test('formatTeksKeJam harus mengembalikan fallback untuk string kosong', () {
  ...
  group('FormatUang', () {
    ...
    test('formatMataUang harus memformat jumlah standar dengan pemisah ribuan',
        () {
    ...
    test('formatMataUang harus menangani angka floating point dengan pembulatan', () {
